...
const App = () => {
  ...
  return (
    <Box textAlign="center" fontSize="xl" p={4} bg="gray.100" minH="100vh" display={'flex'} justifyContent={'center'} alignItems={'center'} bgGradient='linear(to-r, green.200, pink.500)' >
      <VStack>

      <Heading color={'white'} fontSize={56} mb={15}>Welcome to Rock-Paper-Scissors Game</Heading>
      {!loggedIn ? (
